...
const Index = () => {
  return(
    ...
    <section className="wn__product__area brown--color pt--80  pb--30">
        <div className="container">
            ...
            <div className="furniture--4 border--round arrows_style row ">
                ...
                <div className="product product__style--3 col-md-2 ">
                    ...
                    <div className="product__content content--center">
                        ...
                        <ul className="price d-flex">
                            <li>$35.00</li>
                            <li className="old_price">$35.00</li>
                        </ul>
                ...
                <div className="product product__style--3 col-md-2">
                    <div className="product__thumb">
                        <a className="first__img" href="single-product.html"><img src="images/books/5.jpg"
                                                                              alt="product image"/></a>
                        <a className="second__img animation1" href="single-product.html"><img
                ...
                <div className="product product__style--3 col-md-2">
                    ...
                    <div className="product__content content--center">
                        ...
                        <ul className="price d-flex">
                            <li>$35.00</li>
                            <li className="old_price">$50.00</li>
                        </ul>
                        <div className="action">
                            <div className="actions_inner">
                                <ul className="add_to_links">
    ...
    <section className="best-seel-area pt--80 pb--60 ">
        ...
        <div className="slider center row">
         
            <div className="product product__style--3  col-md-2">
                <div className="product__thumb">
                    <a className="first__img" href="single-product.html"><img src="images/best-sell-product/1.jpg"
                                                                          alt="product image"/></a>
                </div>
                <div className="product__content content--center">
                    <div className="action">
            ...
            <div className="product product__style--3 col-md-2">
                <div className="product__thumb">
                    <a className="first__img" href="single-product.html"><img src="images/best-sell-product/2.jpg"
                                                                          alt="product image"/></a>
                </div>
                <div className="product__content content--center">
                    <div className="action">
            ...
            <div className="product product__style--3 col-md-2">
                <div className="product__thumb">
                    <a className="first__img" href="single-product.html"><img src="images/best-sell-product/3.jpg"
                                                                          alt="product image"/></a>
                </div>
                <div className="product__content content--center">
                    <div className="action">
            ...
            <div className="product product__style--3 col-md-2">
                <div className="product__thumb">
                    <a className="first__img" href="single-product.html"><img src="images/best-sell-product/4.jpg"
                                                                          alt="product image"/></a>
                </div>
                <div className="product__content content--center">
                    <div className="action">
            ...
            <div className="product product__style--3 col-md-2">
                <div className="product__thumb">
                    <a className="first__img" href="single-product.html"><img src="images/best-sell-product/5.jpg"
                                                                          alt="product image"/></a>
                </div>
                <div className="product__content content--center">
                    <div className="action">
            ...
            <div className="product product__style--3 col-md-2">
                <div className="product__thumb">
                    <a className="first__img" href="single-product.html"><img src="images/best-sell-product/6.jpg"
                                                                          alt="product image"/></a>
                </div>
                <div className="product__content content--center">
                    <div className="action">
